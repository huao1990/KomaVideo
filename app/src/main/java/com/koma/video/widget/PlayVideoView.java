...
public class PlayVideoView extends SurfaceView implements MediaController.MediaPlayerControl {
    ...
    private boolean mPausedByTransientLossOfFocus; // recording audio focus loss
    ...
    public CharSequence getAccessibilityClassName() {
        return PlayVideoView.class.getName();
    }
    ...
    private MediaPlayer.OnCompletionListener mCompletionListener =
            new MediaPlayer.OnCompletionListener() {
                public void onCompletion(MediaPlayer mp) {
                    ...
                    //// TODO: 6/23/17 hide mediacontroller
    ...
    SurfaceHolder.Callback mSHCallback = new SurfaceHolder.Callback() {
        public void surfaceChanged(SurfaceHolder holder, int format,
                                   int w, int h) {
            LogUtils.i(TAG, "surfaceChanged width : " + w + ",height : " + h);
            mSurfaceWidth = w;
            mSurfaceHeight = h;
    ...
    private AudioManager.OnAudioFocusChangeListener mAudioFocusChangeListener = new
            AudioManager.OnAudioFocusChangeListener() {
                ...
                public void onAudioFocusChange(int focusChange) {
                    LogUtils.i(TAG, "onAudioFocusChange focusChange : " + focusChange);
                    switch (focusChange) {
        ...
        if (isInPlaybackState() && isKeyCodeSupported && mMediaController != null) {
            if (keyCode == KeyEvent.KEYCODE_HEADSETHOOK ||
                ...
                if (mMediaPlayer.isPlaying()) {
                    pause();
                    //// TODO: 6/23/17 show mediacontroller
                } else {
                    start();
                    //// TODO: 6/23/17 hide mediacontroller
                }
    ...
    private void toggleMediaControlsVisiblity() {
        //// TODO: 6/23/17 show or hide mediacontroller
    }
    ...
    public void start() {
        if (isInPlaybackState()) {
            ...
            //// TODO: 6/23/17 update mediacontroller
        }
